...
<SearchBar
  ...
  actionOnRow(item: any) {
    ...
    setTimeout(function() {
      ...
      let code ='+' + item.attributes.country_code
      msg.addData(getName(MessageEnum.CountyCodeDataMessage), code);
  ...
  renderHeaderContainer = () =>{
    return(
      <View style={{flexDirection: 'row'}}>
         <TouchableOpacity style={{width:scale(80),marginBottom:scale(30)}} onPress={()=>this.props.navigation.goBack()}>
          <Image source={IMAGECONST.BackArrow} resizeMode="contain" style={{width: scale(22),
          height: verticalScale(22),marginLeft: scale(17)}} />
         </TouchableOpacity>
         <Text style={{ fontSize: scale(18),fontWeight: '600',}}>{configJSON.headerText}</Text>
